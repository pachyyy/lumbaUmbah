        ...
        <div className="flex justify-between items-center w-[98%] mx-auto">
          ...
          <div className="">
            <ul className="flex gap-[4vw] text-[#0069A8]">
              ...
              <li className="hover:text-white hover:bg-[#0069A8] transition-ease-in-out duration-300 cursor-pointer px-4 py-2 rounded-full"><a href="#">Outlet</a></li>
              <li className="hover:text-white hover:bg-[#0069A8] transition-ease-in-out duration-300 cursor-pointer px-4 py-2 rounded-full"><a href="#">About Us</a></li>
            </ul>
          </div>
          
          {/* Order Button */}
          <div>
            <button className="bg-[#0069A8] text-white rounded-xl px-4 py-3 hover:bg-[#80acc7] cursor-pointer transition-ease-in-out duration-300"><a href="#">Order Now</a></button>
          </div>
        </div>
      </nav>
    </>
